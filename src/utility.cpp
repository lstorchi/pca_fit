...
#define STDDIM_HYBRID_ENDCAP_PRV_VLS_6 21
#define STDDIM_HYBRID_ENDCAP_PRV_VLS_5 70
...
namespace 
{
  ...
  static const char * 
    valid_hybrid_endcap_layers_seq_6[STDDIM_HYBRID_ENDCAP_PRV_VLS_6] = {"51112131415",
                                                                        "51819202122",
                                                                        "5611121314",
                                                                        "5618192021",
                                                                        "567111213",
  ...
  static const char * 
    valid_hybrid_endcap_layers_seq_5[STDDIM_HYBRID_ENDCAP_PRV_VLS_5] = {"1112131415",
                                                                         "1819202122",
                                                                         "511121314",
                                                                         "511121315",
                                                                         "511121415",
    ...
    const int regiontype, const bool tocheck)
{
  if (tocheck)
  {
    ...
    else if (regiontype == ISHYBRID)
    {
      if (maxnumoflayers == 6)
      {
        for (int i=0; i<STDDIM_HYBRID_ENDCAP_PRV_VLS_6; i++)
          if (in.compare(valid_hybrid_endcap_layers_seq_6[i]) == 0)
            return true;
      }
      else if (maxnumoflayers == 5)
      {
        for (int i=0; i<STDDIM_HYBRID_ENDCAP_PRV_VLS_5; i++)
          if (in.compare(valid_hybrid_endcap_layers_seq_5[i]) == 0)
            return true;
      }
    }
