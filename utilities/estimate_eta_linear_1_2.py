...
for i in range(numofline):
  ...
  if (layersids != "5678910"):
    ...
    print "RZ plane using layers 1 and 2: "
    slope = (zval[1]-zval[0])/(rval[1]-rval[0])
    print "layers 1 2 eta: ", eta, "     slope: ", slope,     " diff: ", eta-slope, \
        " theta: ", theta*180.0/math.pi, " pz: ", pz
    intercept = zval[0] - slope*rval[0]
    print "layers 1 2  z0: ", z0,  " intercept: ", intercept, " diff: ", z0-intercept, \
        " eta: " , eta
