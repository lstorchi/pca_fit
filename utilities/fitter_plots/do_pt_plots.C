...
void do_pt_plots(unsigned int flag=0){
  ...
  if ( flag == 1 ) {
    ...
    t->Draw();
    canvas[0]->Update();
    canvas[0]->SaveAs("pt_bias_mup.png");
    ...
    t->Draw();
    canvas[1]->Update();
    canvas[1]->SaveAs("pt_sigma_mup.png");
  ...
  //return;
    ...
    t->Draw();
    canvas[18]->Update();
    canvas[18]->SaveAs("pt_bias_miss_mup.png");
  ...
  //====================================================================================================================
    ...
    t->Draw();
    canvas[19]->Update();
    canvas[19]->SaveAs("pt_sigma_miss_mup.png");
