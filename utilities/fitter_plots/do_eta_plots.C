...
void do_eta_plots(unsigned int flag=0){

  TString filename = "eta_fitted_results.txt";
  ...
  if ( flag == 1 ) {
	...
	g_eta_bias[itow]->SetMinimum(-5.e-4);
	g_eta_bias[itow]->SetMaximum( 5.e-4);
	g_eta_bias[itow]->GetXaxis()->SetTitle("#eta_{bin}");
	g_eta_bias[itow]->GetYaxis()->SetTitle("#LT#eta_{gen}-#eta_{fit}#GT");
    ...
    leg[0]->Draw();
    canvas[0]->Update();
    canvas[0]->SaveAs("eta_bias_tow16-23.png");
    ...
    leg[1]->Draw();
    canvas[1]->Update();
    canvas[1]->SaveAs("eta_bias_tow24-31.png");
  ...
  //====================================================================================================================
    ...
    leg[3] = new TLegend(0.778894, 0.559441, 0.988693, 0.980769);
	...
	g_eta_sigma[itow]->SetMaximum(0.01);
	g_eta_sigma[itow]->GetXaxis()->SetTitle("#eta_{bin}");
	g_eta_sigma[itow]->GetYaxis()->SetTitle("#sigma_{#eta_{gen}-#eta_{fit}}");
    ...
    leg[3]->Draw();
    canvas[3]->Update();
    canvas[3]->SaveAs("eta_sigma_tow16-23.png");
    ...
    leg[4] = new TLegend(0.778894, 0.559441, 0.988693, 0.980769);
    ...
    leg[4]->Draw();
    canvas[4]->Update();
    canvas[4]->SaveAs("eta_sigma_tow24-31.png");
  ...
  //====================================================================================================================
	...
	g_eta_bias_miss[0][itow]->SetMinimum(-5.e-4);
	g_eta_bias_miss[0][itow]->SetMaximum(5.e-4);
	g_eta_bias_miss[0][itow]->GetXaxis()->SetTitle("#eta_{bin}");
	g_eta_bias_miss[0][itow]->GetYaxis()->SetTitle("#LT#eta_{gen}-#eta_{fit}#GT");
    ...
    leg[5]->Draw();
    canvas[5]->Update();
    canvas[5]->SaveAs("eta_bias_missing5_tow16-23.png");
	...
	g_eta_bias_miss[1][itow]->SetMinimum(-5.e-4);
	g_eta_bias_miss[1][itow]->SetMaximum(5.e-4);
	g_eta_bias_miss[1][itow]->GetXaxis()->SetTitle("#eta_{bin}");
	g_eta_bias_miss[1][itow]->GetYaxis()->SetTitle("#LT#eta_{gen}-#eta_{fit}#GT");
    ...
    leg[6]->Draw();
    canvas[6]->Update();
    canvas[6]->SaveAs("eta_bias_missing6_tow16-23.png");
	...
	g_eta_bias_miss[2][itow]->SetMinimum(-5.e-4);
	g_eta_bias_miss[2][itow]->SetMaximum(5.e-4);
	g_eta_bias_miss[2][itow]->GetXaxis()->SetTitle("#eta_{bin}");
	g_eta_bias_miss[2][itow]->GetYaxis()->SetTitle("#LT#eta_{gen}-#eta_{fit}#GT");
    ...
    leg[7]->Draw();
    canvas[7]->Update();
    canvas[7]->SaveAs("eta_bias_missing7_tow16-23.png");
    ...
    leg[8]->Draw();
    canvas[8]->Update();
    canvas[8]->SaveAs("eta_bias_missing5_tow24-31.png");
    ...
    leg[9]->Draw();
    canvas[9]->Update();
    canvas[9]->SaveAs("eta_bias_missing6_tow24-31.png");
    ...
    leg[10]->Draw();
    canvas[10]->Update();
    canvas[10]->SaveAs("eta_bias_missing7_tow24-31.png");
  ...
  //====================================================================================================================
    ...
    leg[11] = new TLegend(0.768844,0.543706,0.977387,0.963287);
	...
	g_eta_sigma_miss[0][itow]->SetMaximum(0.01);
	g_eta_sigma_miss[0][itow]->GetXaxis()->SetTitle("#eta_{bin}");
	g_eta_sigma_miss[0][itow]->GetYaxis()->SetTitle("#sigma_{#eta_{gen}-#eta_{fit}}");
    ...
    leg[11]->Draw();
    canvas[11]->Update();
    canvas[11]->SaveAs("eta_sigma_missing5_tow16-23.png");
    ...
    leg[12] = new TLegend(0.768844,0.543706,0.977387,0.963287);
    ...
    leg[12]->Draw();
    canvas[12]->Update();
    canvas[12]->SaveAs("eta_sigma_missing6_tow16-23.png");
    ...
    leg[13] = new TLegend(0.768844,0.543706,0.977387,0.963287);

    for (int itow=0; itow<8; ++itow) {
      g_eta_sigma_miss[1][itow] = new TGraphErrors(20,eta_bin[itow],eta_sigma_m7[itow],eta_bin_width[itow],eta_dummy[itow]);
      g_eta_sigma_miss[1][itow]->SetTitle("Missing layer 7");
      g_eta_sigma_miss[1][itow]->SetMarkerStyle(20);
      g_eta_sigma_miss[1][itow]->SetMarkerColor(colors[itow]);
      g_eta_sigma_miss[1][itow]->SetLineColor(colors[itow]);

      if ( itow == 0 ){
	g_eta_sigma_miss[1][itow]->Draw("AP");
	g_eta_sigma_miss[1][itow]->SetMinimum(0.);
	g_eta_sigma_miss[1][itow]->SetMaximum(0.01);
	g_eta_sigma_miss[1][itow]->GetXaxis()->SetTitle("#eta_{bin}");
	g_eta_sigma_miss[1][itow]->GetYaxis()->SetTitle("#sigma_{#eta_{gen}-#eta_{fit}}");
	g_eta_sigma_miss[1][itow]->GetYaxis()->SetTitleOffset(1.2);

      }
      else {
	g_eta_sigma_miss[1][itow]->Draw("P");
      }

      leg[13]->AddEntry(g_eta_sigma_miss[1][itow],Form("Tower %d", itow+16),"P");
    
    }

    leg[13]->Draw();
    canvas[13]->Update();
    canvas[13]->SaveAs("eta_sigma_missing7_tow16-23.png");
    ...
    leg[14] = new TLegend(0.768844,0.543706,0.977387,0.963287);

    for (int itow=8; itow<16; ++itow) {
      g_eta_sigma_miss[1][itow] = new TGraphErrors(20,eta_bin[itow],eta_sigma_m5[itow],eta_bin_width[itow],eta_dummy[itow]);
      g_eta_sigma_miss[1][itow]->SetTitle("Missing layer 5");
      g_eta_sigma_miss[1][itow]->SetMarkerStyle(20);
      g_eta_sigma_miss[1][itow]->SetMarkerColor(colors[itow-8]);
      g_eta_sigma_miss[1][itow]->SetLineColor(colors[itow-8]);
	...
	g_eta_sigma_miss[1][itow]->Draw("P");
      ...
      leg[14]->AddEntry(g_eta_sigma_miss[1][itow],Form("Tower %d", itow+16),"P");
    
    }

    leg[14]->Draw();
    canvas[14]->Update();
    canvas[14]->SaveAs("eta_sigma_missing5_tow24-31.png");
    ...
    leg[15] = new TLegend(0.768844,0.543706,0.977387,0.963287);

    for (int itow=8; itow<16; ++itow) {
      g_eta_sigma_miss[2][itow] = new TGraphErrors(20,eta_bin[itow],eta_sigma_m6[itow],eta_bin_width[itow],eta_dummy[itow]);
      g_eta_sigma_miss[2][itow]->SetTitle("Missing layer 6");
      g_eta_sigma_miss[2][itow]->SetMarkerStyle(20);
      g_eta_sigma_miss[2][itow]->SetMarkerColor(colors[itow-8]);
      g_eta_sigma_miss[2][itow]->SetLineColor(colors[itow-8]);

      if ( itow == 8 ){
	g_eta_sigma_miss[2][itow]->Draw("AP");
	g_eta_sigma_miss[2][itow]->SetMinimum(0.0);
	g_eta_sigma_miss[2][itow]->SetMaximum(0.01);
	g_eta_sigma_miss[2][itow]->GetXaxis()->SetTitle("#eta_{bin}");
	g_eta_sigma_miss[2][itow]->GetYaxis()->SetTitle("#sigma_{#eta_{gen}-#eta_{fit}}");
	g_eta_sigma_miss[2][itow]->GetYaxis()->SetTitleOffset(1.2);

      }
      else {
	g_eta_sigma_miss[2][itow]->Draw("P");
      }

      leg[15]->AddEntry(g_eta_sigma_miss[2][itow],Form("Tower %d", itow+16),"P");
    
    }

    leg[15]->Draw();
    canvas[15]->Update();
    canvas[15]->SaveAs("eta_sigma_missing6_tow24-31.png");
    ...
    leg[16] = new TLegend(0.768844,0.543706,0.977387,0.963287);

    for (int itow=8; itow<16; ++itow) {
      g_eta_sigma_miss[2][itow] = new TGraphErrors(20,eta_bin[itow],eta_sigma_m7[itow],eta_bin_width[itow],eta_dummy[itow]);
      g_eta_sigma_miss[2][itow]->SetTitle("Missing layer 7");
      g_eta_sigma_miss[2][itow]->SetMarkerStyle(20);
      g_eta_sigma_miss[2][itow]->SetMarkerColor(colors[itow-8]);
      g_eta_sigma_miss[2][itow]->SetLineColor(colors[itow-8]);
      ...
      if ( itow == 8 ){
	g_eta_sigma_miss[2][itow]->Draw("AP");
	g_eta_sigma_miss[2][itow]->SetMinimum(0.);
	g_eta_sigma_miss[2][itow]->SetMaximum(0.01);
	g_eta_sigma_miss[2][itow]->GetXaxis()->SetTitle("#eta_{bin}");
	g_eta_sigma_miss[2][itow]->GetYaxis()->SetTitle("#sigma_{#eta_{gen}-#eta_{fit}}");
	g_eta_sigma_miss[2][itow]->GetYaxis()->SetTitleOffset(1.2);
	...
	g_eta_sigma_miss[2][itow]->Draw("P");
      ...
      leg[16]->AddEntry(g_eta_sigma_miss[2][itow],Form("Tower %d", itow+16),"P");
    
    }

    leg[16]->Draw();
    canvas[16]->Update();
    canvas[16]->SaveAs("eta_sigma_missing7_tow24-31.png");
