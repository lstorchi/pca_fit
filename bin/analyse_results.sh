...
tail -n +2 $1 | awk '{print $2-$1}' > onept_diff
...
tail -n +2 $1 | awk '{print $5-$4}' > phi_diff
...
tail -n +2 $1 | awk '{print $8-$7}' > eta_diff
...
tail -n +2 $1 | awk '{print $11-$10}' > d0_diff
...
tail -n +2 $1 | awk '{print $14-$13}' > z0_diff
